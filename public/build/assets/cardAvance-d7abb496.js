...
`;S(N);f.render=z;const B={class:"flex justify-center align-center",style:{width:"100%",height:"150px","align-items":"center"}},j={class:""},V={class:"flex justify-center"},T={style:{width:"180px","white-space":"nowrap",overflow:"hidden","text-overflow":"ellipsis","text-align":"center"}},A={style:{"font-size":"1.2rem",color:"var(--primary-color)"}},E=t("div",{class:"flex justify-center"},[t("hr",{style:{width:"50px",border:"solid salmon 2px"}})],-1),$={class:"mt-5",style:{width:"180px"}},q={class:"flex justify-center"},D={style:{"font-weight":"500",color:"var(--primary-color)","font-size":"1.7rem"}},G={__name:"cardAvance",props:{titulo:String,id_escuela:Number,data:null},setup(e){return(a,n)=>(s(),o("div",null,[p(u(g),{style:{height:"200px",width:"240px"}},{content:m(()=>[t("div",B,[t("div",j,[t("div",V,[t("div",T,[t("h1",A,c(e.titulo),1)])]),E,t("div",$,[p(u(f),{value:e.data[e.id_escuela]},{default:m(()=>[h("   ")]),_:1},8,["value"])]),t("div",q,[t("span",D,c(e.data[e.id_escuela])+"%",1)])])])]),_:1})]))}};export{G as default};
