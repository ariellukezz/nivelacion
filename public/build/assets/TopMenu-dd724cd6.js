...
`;jt(Rt);Zt.render=Ft;const Nt={class:"z-10 py-4 bg-white shadow-md",style:{"background-color":"white",height:"75px"}},Ot={class:"container flex justify-between items-center px-6 mx-auto h-full text-purple-600 md:justify-end"},Yt=a("svg",{class:"w-6 h-6","aria-hidden":"true",fill:"currentColor",viewBox:"0 0 20 20"},[a("path",{"fill-rule":"evenodd",d:"M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z","clip-rule":"evenodd"})],-1),Xt=[Yt],Kt={class:"flex",style:{"align-items":"center",height:"37px",color:"#000000D9"}},Gt={style:{"text-align":"end","margin-top":"0px"}},Ut={style:{width:"200px","white-space":"nowrap","text-overflow":"ellipsis",overflow:"hidden"}},Wt={style:{"font-size":"0.9rem"}},qt={style:{"margin-top":"-7px"}},Qt={style:{"font-size":"0.9rem","font-weight":"bold"}},Jt=a("div",{style:{"margin-left":"10px"}},[a("i",{class:"pi pi-angle-down"})],-1),en=a("svg",{class:"mr-3 w-4 h-4","aria-hidden":"true",fill:"none","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",viewBox:"0 0 24 24",stroke:"currentColor"},[a("path",{d:"M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"})],-1),tn={key:1},nn={key:0},on=a("label",null,"Nueva contraseña",-1),sn={style:{width:"100%"}},an={class:"flex justify-end mt-5"},cn={__name:"TopMenu",props:["usuario"],setup(e){const t=e,n=ce(),s=(d,m,p)=>{n.add({severity:d,summary:m,detail:p,life:3e3})};s("success","GUARDADO","--");const o=T(!0),i=T(""),u=async()=>{let d=await axios.post("/save-contrasenia",{contra:i.value});o.value=!1,s(d.data.tipo,d.data.titulo,d.data.mensaje)};return(d,m)=>(l(),c("header",Nt,[a("div",Ot,[a("button",{onClick:m[0]||(m[0]=p=>d.$page.props.showingMobileMenu=!d.$page.props.showingMobileMenu),class:"p-1 mr-5 -ml-1 rounded-md md:hidden focus:outline-none focus:shadow-outline-purple","aria-label":"Menu"},Xt),t.usuario!=null?(l(),v(Ce,{key:0,style:{cursor:"pointer"}},{trigger:b(()=>[a("div",Kt,[a("div",Gt,[a("div",Ut,[a("span",Wt,x(t.usuario.escuela),1)]),a("div",qt,[a("span",Qt,x(t.usuario.nombres),1)])]),Jt])]),content:b(()=>[_(be,{href:d.route("logout"),method:"post",as:"button"},{icon:b(()=>[en,B(" Salir del Sistema ")]),_:1},8,["href"])]),_:1})):g("",!0),t.usuario?(l(),c("div",tn,[t.usuario.e_contra==1?(l(),c("div",nn,[_(k(ee),{visible:o.value,"onUpdate:visible":m[2]||(m[2]=p=>o.value=p),modal:"",header:"Cambiar contraseña",style:{width:"360px"}},{default:b(()=>[on,a("div",sn,[_(k(te),{type:"password",modelValue:i.value,"onUpdate:modelValue":m[1]||(m[1]=p=>i.value=p),style:{width:"315px"}},null,8,["modelValue"])]),a("div",an,[_(k(q),{onClick:u,style:{width:"100%","justify-content":"center"}},{default:b(()=>[B(" Cambiar contraseña ")]),_:1})])]),_:1},8,["visible"])])):g("",!0)])):g("",!0)])]))}};export{We as F,F as R,rn as _,q as a,te as b,ee as c,j as d,R as e,dn as f,cn as g,y as h,K as i,Te as j,Ae as k,V as l,A as m,P as n,H as o,Zt as s};
