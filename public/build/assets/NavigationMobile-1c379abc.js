import{o as l,c as d,A as _,N as I,d as i,m as f,a as b,w as m,b as x,K as V,F as S,r as B,L as se,M as oe,T as M,k as y,S as R,B as v,D as r,y as T,z as D,n as g,f as C,t as $,O as ae,H as le,x as E,U as H,E as z,i as k,V as re,W as L,X as de,j as ce,u as ue,J as pe}from"./app-1f0ff293.js";const me={class:"absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg","aria-hidden":"true"},he={class:"flex"},fe={class:"ml-4"},zn={__name:"NavLink",props:["href","active"],setup(e){return(t,n)=>(l(),d(S,null,[_(i("span",me,null,512),[[I,e.active]]),i("div",he,[f(t.$slots,"icon"),b(x(V),{href:e.href,class:"inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800"},{default:m(()=>[i("span",fe,[f(t.$slots,"default")])]),_:3},8,["href"])])],64))}},Bn="/build/assets/logotiny-e0fccd92.png",ge={class:"flex flex-shrink-0 items-center space-x-6"},Ce={class:"relative"},be={class:"absolute right-0 mt-2 w-56 rounded-md border border-gray-100 bg-white p-2 text-gray-600 shadow-md space-y-2","aria-label":"submenu"},ve={__name:"Dropdown",setup(e){const t=B(!1),n=a=>{t.value&&a.keyCode===27&&(t.value=!1)};return se(()=>document.addEventListener("keydown",n)),oe(()=>document.removeEventListener("keydown",n)),(a,o)=>(l(),d("div",null,[i("ul",ge,[i("li",Ce,[i("div",{onClick:o[0]||(o[0]=s=>t.value=!t.value)},[f(a.$slots,"trigger")]),b(M,{"leave-active-class":"transition duration-150 ease-in","leave-from-class":"opacity-100","leave-to-class":"opacity-0"},{default:m(()=>[_(i("ul",be,[i("li",null,[f(a.$slots,"content")])],512),[[I,t.value]])]),_:3})])])]))}},ye={__name:"DropdownLink",setup(e){return(t,n)=>(l(),y(x(V),{class:"inline-flex w-full items-center rounded-md px-2 py-1 text-sm font-semibold transition-colors duration-150 hover:bg-gray-100 hover:text-gray-800"},{default:m(()=>[f(t.$slots,"icon"),i("span",null,[f(t.$slots,"default")])]),_:3}))}};var w={name:"BaseIcon",props:{label:{type:String,value:void 0},spin:{type:Boolean,value:!1}},methods:{pti(){const e=R.isEmpty(this.label);return{class:["p-icon",{"p-icon-spin":this.spin}],role:e?void 0:"img","aria-label":e?void 0:this.label,"aria-hidden":e}}}};function _e(e,t){t===void 0&&(t={});var n=t.insertAt;if(!(!e||typeof document>"u")){var a=document.head||document.getElementsByTagName("head")[0],o=document.createElement("style");o.type="text/css",n==="top"&&a.firstChild?a.insertBefore(o,a.firstChild):a.appendChild(o),o.styleSheet?o.styleSheet.cssText=e:o.appendChild(document.createTextNode(e))}}var xe=`
.p-icon {
...
`;Rt(Ot);Ft.render=Nt;const Xt={class:"z-10 py-4 bg-white shadow-md",style:{"background-color":"white",height:"75px"}},Yt={class:"container flex justify-between items-center px-6 mx-auto h-full text-purple-600 md:justify-end"},Kt=i("svg",{class:"w-6 h-6","aria-hidden":"true",fill:"currentColor",viewBox:"0 0 20 20"},[i("path",{"fill-rule":"evenodd",d:"M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z","clip-rule":"evenodd"})],-1),Gt=[Kt],Ut={class:"flex",style:{"align-items":"center",height:"37px",color:"#000000D9"}},Wt={style:{"text-align":"end","margin-top":"0px"}},qt={style:{width:"200px","white-space":"nowrap","text-overflow":"ellipsis",overflow:"hidden"}},Jt={style:{"font-size":"0.9rem"}},Qt={style:{"margin-top":"-7px"}},en={style:{"font-size":"0.9rem","font-weight":"bold"}},tn=i("div",{style:{"margin-left":"10px"}},[i("i",{class:"pi pi-angle-down"})],-1),nn=i("svg",{class:"mr-3 w-4 h-4","aria-hidden":"true",fill:"none","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",viewBox:"0 0 24 24",stroke:"currentColor"},[i("path",{d:"M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"})],-1),sn={key:1},on={key:0},an=i("label",null,"Nueva contraseña",-1),ln={style:{width:"100%"}},rn={class:"flex justify-end mt-5"},Mn={__name:"TopMenu",props:["usuario"],setup(e){const t=e,n=ue(),a=(c,h,p)=>{n.add({severity:c,summary:h,detail:p,life:3e3})};a("success","GUARDADO","--");const o=B(!0),s=B(""),u=async()=>{let c=await axios.post("/save-contrasenia",{contra:s.value});o.value=!1,a(c.data.tipo,c.data.titulo,c.data.mensaje)};return(c,h)=>(l(),d("header",Xt,[i("div",Yt,[i("button",{onClick:h[0]||(h[0]=p=>c.$page.props.showingMobileMenu=!c.$page.props.showingMobileMenu),class:"p-1 mr-5 -ml-1 rounded-md md:hidden focus:outline-none focus:shadow-outline-purple","aria-label":"Menu"},Gt),t.usuario!=null?(l(),y(ve,{key:0,style:{cursor:"pointer"}},{trigger:m(()=>[i("div",Ut,[i("div",Wt,[i("div",qt,[i("span",Jt,$(t.usuario.escuela),1)]),i("div",Qt,[i("span",en,$(t.usuario.nombres),1)])]),tn])]),content:m(()=>[b(ye,{href:c.route("logout"),method:"post",as:"button"},{icon:m(()=>[nn,k(" Log Out ")]),_:1},8,["href"])]),_:1})):C("",!0),t.usuario?(l(),d("div",sn,[t.usuario.e_contra==1?(l(),d("div",on,[b(x(te),{visible:o.value,"onUpdate:visible":h[2]||(h[2]=p=>o.value=p),modal:"",header:"Cambiar contraseña",style:{width:"360px"}},{default:m(()=>[an,i("div",ln,[b(x(ne),{type:"password",modelValue:s.value,"onUpdate:modelValue":h[1]||(h[1]=p=>s.value=p),style:{width:"315px"}},null,8,["modelValue"])]),i("div",rn,[b(x(J),{onClick:u,style:{width:"100%","justify-content":"center"}},{default:m(()=>[k(" Cambiar contraseña ")]),_:1})])]),_:1},8,["visible"])])):C("",!0)])):C("",!0)])]))}},dn={class:"absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-purple-600","aria-hidden":"true"},cn={class:"flex"},un={class:"ml-4"},P={__name:"ResponsiveNavLink",props:["href","active"],setup(e){return(t,n)=>(l(),d(S,null,[_(i("span",dn,null,512),[[I,e.active]]),i("div",cn,[f(t.$slots,"icon"),b(x(V),{href:e.href,class:"inline-flex w-full items-center justify-between text-sm font-semibold transition-colors duration-150 hover:text-gray-800"},{default:m(()=>[i("span",un,[f(t.$slots,"default")])]),_:3},8,["href"])])],64))}},pn={class:"fixed inset-0 z-10 flex items-end bg-black bg-opacity-50 sm:items-center sm:justify-center"},mn={class:"fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white md:hidden"},hn={class:"py-4 text-gray-500 dark:text-gray-400"},fn={class:"mt-6"},gn={class:"relative px-6 py-3"},Cn=i("svg",{class:"w-5 h-5","aria-hidden":"true",fill:"none","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",viewBox:"0 0 24 24",stroke:"currentColor"},[i("path",{d:"M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"})],-1),bn={class:"relative px-6 py-3"},vn=i("svg",{class:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg"},[i("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"})],-1),yn={class:"relative px-6 py-3"},_n=i("svg",{class:"w-5 h-5","aria-hidden":"true",fill:"none","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",viewBox:"0 0 24 24",stroke:"currentColor"},[i("path",{d:"M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"})],-1),xn={class:"relative px-6 py-3"},wn=i("span",{class:"inline-flex items-center"},[i("svg",{class:"w-5 h-5","aria-hidden":"true",fill:"none","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",viewBox:"0 0 24 24",stroke:"currentColor"},[i("path",{d:"M4 6h16M4 10h16M4 14h16M4 18h16"})]),i("span",{class:"ml-4"},"Two-level menu")],-1),$n=i("svg",{class:"w-4 h-4","aria-hidden":"true",fill:"currentColor",viewBox:"0 0 20 20"},[i("path",{"fill-rule":"evenodd",d:"M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z","clip-rule":"evenodd"})],-1),kn=[wn,$n],Ln={class:"p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50 dark:text-gray-400 dark:bg-gray-900","aria-label":"submenu"},In=i("li",{class:"px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"},[i("a",{class:"w-full",href:"#"},"Child menu")],-1),En=[In],Tn={__name:"NavigationMobile",setup(e){let t=B(!1);return(n,a)=>(l(),d(S,null,[b(M,{"enter-active-class":"transition ease-in-out duration-150","enter-from-class":"opacity-0","enter-to-class":"opacity-100","leave-active-class":"transition ease-in-out duration-150","leave-from-class":"opacity-100","leave-to-class":"opacity-0"},{default:m(()=>[_(i("div",pn,null,512),[[I,n.$page.props.showingMobileMenu]])]),_:1}),b(M,{"enter-active-class":"transition ease-in-out duration-150","enter-from-class":"opacity-0 transform -translate-x-20","enter-to-class":"opacity-100","leave-active-class":"transition ease-in-out duration-150","leave-from-class":"opacity-100","leave-to-class":"opacity-0 transform -translate-x-20"},{default:m(()=>[_(i("aside",mn,[i("div",hn,[b(x(V),{class:"ml-6 text-lg font-bold text-gray-800",href:n.route("dashboard")},{default:m(()=>[k(" Windmill ")]),_:1},8,["href"]),i("ul",fn,[i("li",gn,[b(P,{href:n.route("dashboard"),active:n.route().current("dashboard")},{icon:m(()=>[Cn]),default:m(()=>[k(" Dashboard ")]),_:1},8,["href","active"])]),i("li",bn,[b(P,{href:n.route("users.index"),active:n.route().current("users.index")},{icon:m(()=>[vn]),default:m(()=>[k(" Users ")]),_:1},8,["href","active"])]),i("li",yn,[b(P,{href:n.route("about"),active:n.route().current("about")},{icon:m(()=>[_n]),default:m(()=>[k(" About us ")]),_:1},8,["href","active"])]),i("li",xn,[i("button",{onClick:a[0]||(a[0]=o=>pe(t)?t.value=!x(t):t=!x(t)),class:"inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800","aria-haspopup":"true"},kn),_(i("ul",Ln,En,512),[[I,x(t)]])])])])],512),[[I,n.$page.props.showingMobileMenu]])]),_:1})],64))}};export{Je as F,O as R,zn as _,J as a,ne as b,te as c,X as d,Y as e,Bn as f,Tn as g,Mn as h,Z as i,w as j,De as k,G as l,Ze as m,Ft as s};
