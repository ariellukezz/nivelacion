      ...
      <Link class="text-lg font-bold text-blue-500" :href="route('dashboard')">
        ...
        <ul class="mt-6">
          ...
          <li class="relative px-6 py-3">
            <ResponsiveNavLink :href="route('estudiante-inicio')" :active="route().current('estudiante-inicio')">
              <template #icon>
          ...
          <li class="relative px-6 py-3">
            <ResponsiveNavLink :href="route('estudiante-notas')" :active="route().current('estudiante-notas')">
              <template #icon>
                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                     stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path
        ...
        <li class="relative px-6 py-3">
            <ResponsiveNavLink :href="route('estudiante.historial-notas')" :active="route().current('estudiante.historial-notas')">
              <template #icon>
                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                     stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path
          ...
          <li class="relative px-6 py-3">
            <ResponsiveNavLink :href="route('estudiante-encuestas')" :active="route().current('estudiante-encuestas')">
              <template #icon>
