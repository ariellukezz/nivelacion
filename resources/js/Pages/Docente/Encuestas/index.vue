...
<AuthenticatedLayout>   
  ...
  <div>
    <Dialog v-model:visible="modalEncuesta" modal header="Encuesta docente" :style="{ width: '80vw', scale:'0.9' }">
      <div>
...
const cursos = ref([])
const getCursos = ( ) => {
  axios.get('/docente/cursos-encuesta', { })
    .then(response => {
...
const save = () => {
  axios.post('save-encuesta-docente',{
