...
async function cargar() {
  ...
  try {
    ...
    const { data } = await axios.post('/superadmi/listar-notificaciones', payload)
...
async function validarFiltros() {
  ...
  try {
    ...
    const { data } = await axios.post('/superadmi/buscar-usuarios-notificaciones', payload)
...
async function crear() {
  ...
  try {
    ...
    const { data } = await axios.post('/superadmi/guardar-notificacion', fd, {
...
async function guardarEdicion() {
  ...
  try {
    ...
    const { data } = await axios.post(`/superadmi/actualizar-notificacion/${id}`, fd, {
      headers: { 'Content-Type': 'multipart/form-data' }
    })
...
async function eliminar(n) {
  ...
  cargando.value = true
  try {
    const { data } = await axios.post(`/superadmi/eliminar-notificacion/${n.id}`)
