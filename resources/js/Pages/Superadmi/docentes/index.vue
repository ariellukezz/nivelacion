  ...
  <div class="bg-white shadow-xs p-4" style=" height: calc(100vh - 110px); font-family: Arial, Helvetica, sans-serif;">
      ...
      <div>
        <div class="card">
          ...
          <DataTable :value="docentes" :class="'p-datatable-sm'" paginator :rows="15" :rowsPerPageOptions="[10, 20, 50]" tableStyle="min-width: 50rem" style="font-size: .9rem;">
...
const guardar = async () => {
  try {
    const res = await axios.post("save-docente", {
      id: docente.value.id,
      ...
      id_docente: docente.value.id_docente,
